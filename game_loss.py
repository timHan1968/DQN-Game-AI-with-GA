...
def play(action):
      ...
      while (time.time()-startTime < 0.05):
            ...
            if allHitGround(balls) or allBricksGone(rectX):
                ...
                if allBricksGone(rectX):
                    reward = 1000
                elif allHitGround(balls):
                    reward = -1000
...
#policy_dqn.load_state_dict(torch.load(r"C:\Users\Lector\Desktop\breakout\weights\policy.pt"))
#target_dqn.load_state_dict(torch.load(r"C:\Users\Lector\Desktop\Breakout\Weights\target.pt"))
target_dqn.eval()
...
def getAction(state):
	...
	if sample > eps:
		...
		# print("Step by random generator")
...
# -----------------------------------------------------
	...
	if steps_done % TARGET_UPDATE == 0:
		target_dqn.load_state_dict(policy_dqn.state_dict())
		torch.save(target_dqn.state_dict(), r"C:\Users\Lector\Desktop\breakout\weights\target.pt")
